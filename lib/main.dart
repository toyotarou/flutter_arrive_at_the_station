...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'Clickable Japan Map Sample',
      theme: ThemeData(colorScheme: ColorScheme.fromSeed(seedColor: Colors.blue), useMaterial3: true),
      home: const JapanMapPage(),
    );
  }
}
...
class JapanMapPage extends StatefulWidget {
  const JapanMapPage({super.key});

  @override
  State<JapanMapPage> createState() => _JapanMapPageState();
}

class _JapanMapPageState extends State<JapanMapPage> {
